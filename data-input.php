...
if(isset($_GET['status'])){
    ...
    if($_GET['status'] == 'failed'){
        echo "<script>alert('Gagal menambahkan data selebriti. Silakan coba lagi.');</script>";
    }
}
?>
<!doctype html>
			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Input Selebriti</h3>
							</div>
							<div class="col-sm-6">
									    ...
									    <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="profesi" name="profesi" required>
                                                    ...
                                                    <?php 
                                                    // Iterasi daftar profesi dan menampilkannya sebagai opsi dalam dropdown
                                                    foreach ($profesiList as $profesi){
                                                        echo '<option value="'.$profesi['id'].'">'.$profesi['nama'].'</option>';
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="medsos" name="medsos" placeholder="Masukkan Media Sosial"  required>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="status" name="status" required>
                                                    ...
                                                    <?php 
                                                    // Iterasi daftar status selebriti dan menampilkannya sebagai opsi dalam dropdown
