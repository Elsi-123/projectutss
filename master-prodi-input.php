...
if(isset($_GET['status'])){
    if($_GET['status'] == 'failed'){
        echo "<script>alert('Gagal menambahkan data profesi. Silakan coba lagi.');</script>";
    }
}
			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Input Profesi</h3>
							</div>
							<div class="col-sm-6">
								<ol class="breadcrumb float-sm-end">
									<li class="breadcrumb-item"><a href="index.php">Beranda</a></li>
									<li class="breadcrumb-item active" aria-current="page">Input Profesi</li>
								</ol>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-12">
								<div class="card">
                                    ...
                                    <form action="proses/proses-profesi.php?aksi=inputprofesi" method="POST">
									    <div class="card-body">
                                            <div class="mb-3">
                                                <label for="nama" class="form-label">Kode Profesi</label>
                                                <input type="text" class="form-control" id="kode" name="kode" placeholder="Masukkan Kode Profesi" required>
                                            </div>
											<div class="mb-3">
												<label for="nama" class="form-label">Nama Profesi</label>
												<input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Profesi" required>
											</div>
                                        </div>
